        ...
        <main className="lg:col-span-3 space-y-10">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6 shadow-xl">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">Select your target region to automatically load corresponding countries and cities.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between">
                <div className="h-40 bg-slate-800 relative">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    <span className="bg-amber-500 text-slate-950 text-xs px-2.5 py-1 rounded-full font-bold shadow">★ 4.9 Rating</span>
                    <span className="bg-rose-500 text-white text-xs px-2.5 py-1 rounded-full font-bold shadow">25% OFF</span>
                  </div>
                </div>
                <div className="p-5 flex flex-col justify-between flex-grow">
                  <div>
                    <h4 className="font-bold text-lg text-white">Aetros Grand Signature Suite - {selectedCity}</h4>
                    <p className="text-xs text-slate-400 mt-1">Starting from <span className="text-emerald-400 font-bold text-sm">$120 / night</span></p>
                  </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between">
                <div className="h-40 bg-slate-800 relative">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    <span className="bg-amber-500 text-slate-950 text-xs px-2.5 py-1 rounded-full font-bold shadow">★ 4.8 Rating</span>
                    <span className="bg-emerald-500 text-slate-950 text-xs px-2.5 py-1 rounded-full font-bold shadow">Weekend Special</span>
                  </div>
                </div>
                <div className="p-5 flex flex-col justify-between flex-grow">
                  <div>
